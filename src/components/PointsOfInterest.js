  ...
  return (
    <div>
      <div className='flex justify-between items-center mb-2'>
        ...
        <button className='text-white bg-blue-500 p-1 pl-3 pr-3 rounded-md capitalize duration-300 max-md:text-base hover:bg-blue-700 hover:text-white max-sm:text-sm'>
          <Link 
          to={"/point_of_interest_page"}>full view </Link> </button>
